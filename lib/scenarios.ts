...
export const SCENARIOS: Record<string, Scenario> = {
  ...
  mei: {
    ...
    beats: [
      ...
      { who: "caller", text: "Oh — no, definitely not then. The hot and sour noodles instead?" },
      { who: "system", actions: [{ kind: "guardian", sku: "suan_la_fen" }], note: "Nothing in that name says peanut. This is where it stops looking like keyword matching." },
  ...
  danny: {
    ...
    beats: [
      ...
      { who: "caller", text: "Pickup. Can I get the wonton soup, the green beans, and the mapo tofu?" },
      { who: "system", actions: [{ kind: "guardian", sku: "wonton_soup" }], note: "Dried shrimp in the broth base. Nothing on the menu would tell you." },
      { who: "system", actions: [{ kind: "guardian", sku: "gan_bian_si_ji_dou" }], note: "Reads vegetarian. The wok base carries dried shrimp paste." },
