...
export const MENU: MenuItem[] = [
  ...
  { sku: "suan_cai_yu", name_en: "Pickled Mustard Green Fish", name_zh: "酸菜鱼", pinyin: "suān cài yú", category: "Seafood", price_cents: 2850, english_listed: false, station: "wok", base_spice: 2, available: true, allergens: [], order_phrase_zh: "我要一个酸菜鱼，中辣", blurb: "Sour pickled greens, white fish, numbing broth. Black cod on weekdays." },
  ...
  { sku: "suan_la_fen", name_en: "Hot & Sour Sweet Potato Noodles", name_zh: "酸辣粉", pinyin: "suān là fěn", category: "Noodles", price_cents: 1150, english_listed: true, station: "wok", base_spice: 4, available: true, allergens: ["peanut", "soy"], hidden_allergen_note: "the vinegar-chilli base is finished with crushed peanut; nothing in the name says so", order_phrase_zh: "我要一个酸辣粉", blurb: "Slippery sweet-potato noodles, vinegar heat, fried soybean." },
...
export const CONFIRMATIONS: Confirmation[] = [
  ...
  { sku: "suan_la_fen", allergen: "peanut", present: true, confirmed_on: "2026-05-02", source: "staff", note: "The hot-and-sour base is finished with crushed peanut. Nothing in the English name says so." },
